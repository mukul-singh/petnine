...
$(document).ready(function() {
    ...
    try {
        // in case prettyphoto js is not loaded then catch error
    ...
    $(".expand-filter").click(function() {
        $(this).parent().parent().find(".filter-set").slideToggle("fast");
    ...
    $(".filters .toggle-up").click(function() {
        $('html, body').animate({
            scrollTop: $("html").offset().top
        }, 300);
    });
    
    $(".bs-option").click(function() {
        $(".bs-option").find(".tbr").remove();
        var html = '<span class="tbr"><br/><i class="fa fa-3x fa-caret-down color-pn" style="position:absolute;bottom:-20px;"></i></span>';
        $(this).append(html);
    ...
    $(window).scroll(function() {
        var pos = $(".business-sections").css("position");
        if(pos == "fixed") {
            $(".bs-hidden").show();
        }
        else {
